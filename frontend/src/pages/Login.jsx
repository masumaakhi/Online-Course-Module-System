...
const Login = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        // For email login, ensure the token from the response is saved
        // Assuming your backend sends a token for email/password login as well
        if(data.token) {
    ...
    <div className='flex flex-col items-center mt-20 px-4 text-center'>
      <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
        ...
        <form onSubmit={onSubmitHandler}>
          ...
          >
            {/* SVG for Google Icon */}
            <svg className="w-5 h-5 mr-2" viewBox="0 0 488 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path d="M488 261.8c0-17.8-1.5-35.1-4.3-51.8H249v98h135.4c-5.8 31.2-23.5 57.6-50 75.2v62.2h80.8c47.4-43.6 74.8-108 74.8-183.6z" fill="#4285F4" />
              <path d="M249 492c67.8 0 124.8-22.4 166.4-60.8l-80.8-62.2c-22.6 15.2-51.2 24.2-85.6 24.2-65.8 0-121.5-44.4-141.4-104.2H24v65.2C65.3 429.5 150.3 492 249 492z" fill="#34A853" />
              <path d="M107.6 289c-4.8-14.4-7.6-29.6-7.6-45s2.8-30.6 7.6-45v-65.2H24C8.7 160.3 0 203.3 0 244s8.7 83.7 24 116.2l83.6-65.2z" fill="#FBBC05" />
              <path d="M249 97.6c35.7 0 67.7 12.3 92.8 36.3l69.6-69.6C373.8 27.6 316.8 0 249 0 150.3 0 65.3 62.5 24 127.8l83.6 65.2C127.5 142 183.2 97.6 249 97.6z" fill="#EA4335" />
            </svg>
            Continue with Google
          </button>
          <div className='flex mb-4 items-center gap-4 w-full px-5 py-2 rounded-full bg-[#333A5C]'>
