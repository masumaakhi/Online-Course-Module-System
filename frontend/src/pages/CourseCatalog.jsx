  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur p-5 sm:p-6 shadow-[0_40px_120px_-30px_rgba(0,0,0,.55)] mb-6">
          <div className="grid gap-4 md:grid-cols-[1fr,auto] md:items-center">
            ...
            <button
              ...
              className="justify-self-start md:justify-self-end rounded-2xl border border-white/15 bg-white/5 px-4 py-2 text-sm hover:bg-white/10"
            >
              Clear Filters
            </button>
          </div>
        ...
        {options.map((opt, idx) => {
          ...
          return (
            <button
              ...
              className={
                "px-3 sm:px-4 py-2 text-sm border-r border-white/10 last:border-r-0 " +
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        <p className="mt-1 text-sm text-slate-300 line-clamp-3">{description}</p>
          ...
          <div className="flex items-center gap-2">
            {isFree ? (
              ...
              <>
                ...
                <span className="text-emerald-300 font-bold">${finalPrice.toFixed(2)}</span>
              </>
            )}
          </div>
